...
export class CreditNoteService {
    constructor(
        ...
        @InjectRepository(purchasing_creditNote)
        private creditNoteRepository: Repository<purchasing_creditNote>,
    ...
    async create(createCreditNoteDto: CreateCreditNoteDto, userId: number) {
        ...
        const newCreditNote = this.creditNoteRepository.create({
            ...otherFields,
        ...
        await this.creditNoteRepository.save(newCreditNote);

        return 'This action adds a new Credit Note';
    }

    async findAll(query: any): Promise<{ totalRows: number; data: purchasing_creditNote[] }> {
    ...
    async findOne(id: number): Promise<purchasing_creditNote> {
        const relations = {
            user: true,
            userUpdate: true,
            typeMoney: true,
    ...
    async listMoney(): Promise<purchasing_creditNote[]> {
